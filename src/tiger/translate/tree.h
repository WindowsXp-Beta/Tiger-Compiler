...
public:
  ...
  virtual Stm *Canon() = 0;
  virtual void Munch(assem::InstrList &instr_list, std::string_view fs,
                     frame::RegManager *reg_manager) = 0;
  // Used for Canon
  bool IsNop();
...
public:
  ...
  Stm *Canon() override;
  void Munch(assem::InstrList &instr_list, std::string_view fs,
             frame::RegManager *reg_manager) override;
};
...
public:
  ...
  virtual temp::Temp *Munch(assem::InstrList &instr_list, std::string_view fs,
                            frame::RegManager *reg_manager) = 0;
};
...
public:
  ...
  temp::Temp *Munch(assem::InstrList &instr_list, std::string_view fs,
                    frame::RegManager *reg_manager) override;
};
